...
PH1100_SENSORS = [
    ...
    Sensor(10107, "MaximumGridChargeCurrent",        0.01,    "A",      Platform.NUMBER,               NumberDeviceClass.CURRENT,         True,  ),
    Sensor(10108, "ConstantChargeV",                 0.01,    "V",      Platform.NUMBER,               NumberDeviceClass.VOLTAGE,         True,  ),
    Sensor(10109, "FloatChargeV",                    0.01,    "V",      Platform.NUMBER,               NumberDeviceClass.VOLTAGE,         True,  ),
    Sensor(10110, "MinCurrentChargeVoltage",         0.01,    "V",      Platform.NUMBER,               NumberDeviceClass.VOLTAGE,         True,  ),
    Sensor(10111, "MinCurrentChargeCurrent",         0.01,    "A",      Platform.NUMBER,               NumberDeviceClass.CURRENT,         True,  ),
    Sensor(10113, "MinCurrentChargeSoc",             1,       "%",      Platform.NUMBER,               None,                              True,  ),
    Sensor(10114, "BatteryVLowAlarm",                0.01,    "V",      Platform.NUMBER,               NumberDeviceClass.VOLTAGE,         True,  ),
    Sensor(10115, "BatterySocLowAlarm",              1,       "%",      Platform.NUMBER,               None,                              True,  ),
    Sensor(10116, "EQChargeVoltage",                 0.01,    "V",      Platform.NUMBER,               NumberDeviceClass.VOLTAGE,         True,  ),
    ...
    Sensor(10122, "UserModeBattVMax",                0.01,    "V",      Platform.NUMBER,               NumberDeviceClass.VOLTAGE,         True,  ),
    Sensor(10123, "UserModeBattVMin",                0.01,    "V",      Platform.NUMBER,               NumberDeviceClass.VOLTAGE,         True,  ),
    Sensor(10126, "AdvModeDefault",                  None,    None,     Platform.SELECT,               None,                              True,  ),
    Sensor(10127, "AdvModeT1Start",                  None,    None,     Platform.TIME,                 None,                              True,  ),
    Sensor(10128, "AdvModeT1End",                    None,    None,     Platform.TIME,                 None,                              True,  ),
    Sensor(10129, "AdvModeT1WorkMode",               None,    None,     Platform.SELECT,               None,                              True,  ),
    Sensor(10130, "AdvModeT2Start",                  None,    None,     Platform.TIME,                 None,                              True,  ),
    Sensor(10131, "AdvModeT2End",                    None,    None,     Platform.TIME,                 None,                              True,  ),
    Sensor(10132, "AdvModeT2WorkMode",               None,    None,     Platform.SELECT,               None,                              True,  ),
    Sensor(10133, "AdvModeT3Start",                  None,    None,     Platform.TIME,                 None,                              True,  ),
    Sensor(10134, "AdvModeT3End",                    None,    None,     Platform.TIME,                 None,                              True,  ),
    Sensor(10135, "AdvModeT3WorkMode",               None,    None,     Platform.SELECT,               None,                              True,  ),
    Sensor(10136, "AdvModeT4Start",                  None,    None,     Platform.TIME,                 None,                              True,  ),
    Sensor(10137, "AdvModeT4End",                    None,    None,     Platform.TIME,                 None,                              True,  ),
    Sensor(10138, "AdvModeT4WorkMode",               None,    None,     Platform.SELECT,               None,                              True,  ),
    Sensor(10139, "AdvModeT5Start",                  None,    None,     Platform.TIME,                 None,                              True,  ),
    Sensor(10140, "AdvModeT5End",                    None,    None,     Platform.TIME,                 None,                              True,  ),
    Sensor(10141, "AdvModeT5WorkMode",               None,    None,     Platform.SELECT,               None,                              True,  ),
    Sensor(10142, "AdvModeT6Start",                  None,    None,     Platform.TIME,                 None,                              True,  ),
    Sensor(10143, "AdvModeT6End",                    None,    None,     Platform.TIME,                 None,                              True,  ),
    Sensor(10144, "AdvModeT6WorkMode",               None,    None,     Platform.SELECT,               None,                              True,  ),
    ...
    Sensor(10124, "WMSocHigh",                       None,    "%",      Platform.NUMBER,               None,                              True,  ),
    Sensor(10125, "WMSocLow",                        None,    "%",      Platform.NUMBER,               None,                              True,  ),
    Sensor(20213, "AntirefluxEnable",                None,    None,     Platform.SWITCH,               None,                              True,  ),
    # RTC
    Sensor(20201, "RTCYear",                         1,       None,     Platform.NUMBER,               None,                              True,  ),
    Sensor(20202, "RTCMonth",                        1,       None,     Platform.NUMBER,               None,                              True,  ),
    Sensor(20203, "RTCDay",                          1,       None,     Platform.NUMBER,               None,                              True,  ),
    Sensor(20204, "RTCDayOfTheWeek",                 1,       None,     Platform.NUMBER,               None,                              True,  ),
    Sensor(20205, "RTCHour",                         1,       None,     Platform.NUMBER,               None,                              True,  ),
    Sensor(20206, "RTCMinutes",                      1,       None,     Platform.NUMBER,               None,                              True,  ),
    Sensor(20207, "RTCSeconds",                      1,       None,     Platform.NUMBER,               None,                              True,  ),
]
# fmt: on
...
OPTIONS = {
    ...
    "AdvModeT1WorkMode": ["store_mode", "load_first", "battery_first", "grid_first", "advanced_mode"],
    "AdvModeT2WorkMode": ["store_mode", "load_first", "battery_first", "grid_first", "advanced_mode"],
    "AdvModeT3WorkMode": ["store_mode", "load_first", "battery_first", "grid_first", "advanced_mode"],
    "AdvModeT4WorkMode": ["store_mode", "load_first", "battery_first", "grid_first", "advanced_mode"],
    "AdvModeT5WorkMode": ["store_mode", "load_first", "battery_first", "grid_first", "advanced_mode"],
    "AdvModeT6WorkMode": ["store_mode", "load_first", "battery_first", "grid_first", "advanced_mode"],
}
...
RANGES = {
    ...
    "WMSocHigh":                      lambda data: Range(0,     100,    1   ),
    "WMSocLow":                       lambda data: Range(0,     100,    1   ),
    ...
    "BatteryVLowFault":               lambda data: Range(40,    50,     0.01),
    "BatteryVLowRecover":             lambda data: Range(40,    60,     0.01),
    "MaximumChargeCurrent":           lambda data: Range(0,     240,    0.1 ),
    "MaximumDischargeCurrent":        lambda data: Range(0,     240,    0.1 ),
    "MaximumGridChargeCurrent":       lambda data: Range(0,     30,     0.1 ),
    "ConstantChargeV":                lambda data: Range(40,    65,     0.01),
    "FloatChargeV":                   lambda data: Range(40,    65,     0.01),
    "MinCurrentChargeVoltage":        lambda data: Range(40,    65,     0.01),
    "MinCurrentChargeCurrent":        lambda data: Range(0,     100,    0.1 ),
    "MinCurrentChargeSoc":            lambda data: Range(0,     100,    1   ),
    "BatteryVLowAlarm":               lambda data: Range(40,    60,     0.01),
    "BatterySocLowAlarm":             lambda data: Range(0,     100,    1   ),
    "EQChargeVoltage":                lambda data: Range(40,    60,     0.01),
    "UserModeBattVMax":               lambda data: Range(40,    65,     0.01),
    "UserModeBattVMin":               lambda data: Range(40,    65,     0.01),
